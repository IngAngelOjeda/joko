...
public class AuthorizationManagerImpl implements JokoAuthorizationManager {
    ...
    public void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers(ApiPaths.COUNTRIES, ApiPaths.COUNTRIES + "/**").permitAll()
                .antMatchers(ApiPaths.ROOT_AUDIT_EVENTS + "/**").permitAll()
...
//                .antMatchers(ApiPaths.COUNTRIES + "/**").hasAnyAuthority(ADMIN.name())
                ;
